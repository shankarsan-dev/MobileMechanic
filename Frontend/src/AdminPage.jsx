...
const AdminPage = () => {
  return (
    <div className="p-6 bg-gray-100 min-h-screen flex flex-col items-center justify-center"> {/* Centering the content */}
      ...
      <div className="flex flex-row items-center space-x-4 justify-center"> {/* Horizontal spacing */}
        <Link to="/admin/mechanics">
          <button className="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600 max-w-sm flex flex-col items-center"> {/* Flex column for image and text */}
        ...
        <Link to="/admin/pending-mechanics">
          <button className="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600 max-w-sm flex flex-col items-center"> {/* Flex column for image and text */}
            <img src="src/assets/identity-card.png" alt="Service Details" className="mb-2" /> {/* Space below image */}
            Verify Mechanics
          </button>
        </Link>
